...
<%--                            </div>--%>
<%--                        </div>--%>
<%--                        <h5 class="text-center h5 mb-0">Uday</h5>--%>
    ...
    <div class="main-content">
        <div class="profile-card">
            <div class="profile-header">
                ...
                <%
                    try {
                        ...
                        if (rs.next())
                        {
                            String nme = rs.getString("adminname");
                %>
                <h1 class="profile-name"><%= nme %></h1>
                <%
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
            ...
            <div class="profile-details">
                ...
                <p><strong>Phone:</strong>+91 9987 568 567</p>
